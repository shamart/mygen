...
public class Inflector implements TemplateMethodModelEx {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Inflector.getInstance().pluralize("authority"));
        // 复数转单数
    ...
    public Object exec(List list) throws TemplateModelException {
        ...
        return Inflector.getInstance().pluralize(pre);
    }
